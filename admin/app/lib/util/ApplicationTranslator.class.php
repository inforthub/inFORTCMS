...
class ApplicationTranslator
{
	...
	// Sistema
        ...
        $this->messages['en'][] = 'Move up';
        $this->messages['en'][] = 'Move down';
        $this->messages['en'][] = 'Incorrect Username or Password';
        $this->messages['en'][] = 'geoPlugin class Error: Cannot retrieve data. Either compile PHP with cURL support or enable allow_url_fopen in php.ini';
        $this->messages['en'][] = 'Clone';
        $this->messages['en'][] = 'A directory with this name already exists.';
        $this->messages['en'][] = 'Clicks Stats';
        ...
        $this->messages['pt'][] = 'Erro na classe geoPlugin: Não é possível recuperar dados. Compile o PHP com suporte a cURL ou ative o allow_url_fopen no php.ini';
        $this->messages['pt'][] = 'Clonar';
        $this->messages['pt'][] = 'Já existe um diretório com este nome.';
        $this->messages['pt'][] = 'Estatísticas de cliques';
