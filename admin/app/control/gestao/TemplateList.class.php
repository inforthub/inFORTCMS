...
class TemplateList extends TPage
{
    ...
    public function __construct()
    {
        ...
        // add the fields
        $this->form->addFields( [ new TLabel('Template') ], [ $nome ] , [ new TLabel('Nome Fisico') ], [ $nome_fisico ] );
    ...
    public static function onSaveClone($param)
    {
        try
        {
            ...
            $obj->padrao = 'f';
            $obj->setPosicoes($template_orig->getPosicoes()); // clonamos todas as posições da template
            $obj->store();
