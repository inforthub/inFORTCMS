 ...
 *
 */
class TrafegoRegiaoView extends TPage
{
    ...
    public function __construct( $param )
    {
        ...
        try
        {
            ...
            // carregamos os dados
            $paginas = Trafego::porCampo('regiao',$periodo,$limit);
            ...
            $paginas_list->addColumn( new TDataGridColumn('regiao', 'Estado', 'left') );
            ...
            $panel = new TPanelGroup('Estados - TOP '.$limit, '#f5f5f5');
