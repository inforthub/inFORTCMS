 ...
 *
 */
class TrafegoPaisView extends TPage
{
    ...
    public function __construct( $param )
    {
        ...
        try
        {
            ...
            // carregamos os dados
            $paginas = Trafego::porCampo('pais',$periodo,$limit);
            ...
            $paginas_list->addColumn( new TDataGridColumn('pais', 'País', 'left') );
            ...
            $panel = new TPanelGroup('Países - TOP '.$limit, '#f5f5f5');
