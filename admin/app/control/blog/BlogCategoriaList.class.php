...
class BlogCategoriaList extends TPage
{
    ...
    public function __construct()
    {
         ...
         * 3- News
         *****************************/
        $this->setCriteria( TCriteria::create(['tipo_id'=>2,'modo'=>'c']) ); // define a standard filter
        ...
        $this->addActionButton(_t('New'),  new TAction(['BlogCategoriaForm', 'onEdit']), 'fa:plus green');
        ...
        $action1 = new TDataGridAction(['BlogCategoriaForm', 'onEdit'], ['id'=>'{id}','register_state' => 'false']);
