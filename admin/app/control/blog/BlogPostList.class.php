...
class BlogPostList extends TPage
{
    ...
    public function __construct()
    {
         ...
         * 3- News
         *****************************/
        $this->setCriteria( TCriteria::create(['tipo_id'=>2,'modo'=>'a']) ); // define a standard filter
        //$this->setCriteria( TCriteria::create(['tipo_id'=>2]) ); // define a standard filter
        //*****************************
        
        // creates the form
        $this->form = new BootstrapFormBuilder('form_search_BlogPost');
        ...
        //$url        = new TEntry('url');
        $usuario_id = new TCombo('usuario_id');
        $ativo      = new TCombo('ativo');
        $ativo->addItems(['t'=>'Sim','f'=>'Não']);


        // add the fields
        $this->form->addFields( [ new TLabel('Título') ], [ $titulo ] , [ new TLabel('Autor') ], [ $usuario_id ] );
        ...
        $this->addActionButton(_t('New'),  new TAction(['BlogPostForm', 'onEdit']), 'fa:plus green');
        ...
        $column_usuario_id = new TDataGridColumn('usuario_id', 'Autor', 'left');
        $column_categoria_id = new TDataGridColumn('categoria_id', 'Categoria', 'left');
        $column_dt_post = new TDataGridColumn('dt_post', 'Data Post', 'center');
        $column_dt_edicao = new TDataGridColumn('dt_edicao', 'Dt Edição', 'center');
        ...
        $column_usuario_id->setTransformer(['TTransformers','showUserName']);
        $column_categoria_id->setTransformer(['TTransformers','showCategoria']);
        $column_dt_post->setTransformer(['TTransformers','formataDataBR']);
        $column_dt_edicao->setTransformer(['TTransformers','formataDataBR']);
        ...
        $action1 = new TDataGridAction(['BlogPostForm', 'onEdit'], ['id'=>'{id}','register_state' => 'false']);
