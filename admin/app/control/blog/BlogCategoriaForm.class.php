<?php
/**
 * BlogCategoriaForm Registration
 *
 * @version     1.0
 * @package     control
 * @subpackage  blog
 ...
 *
 */
class BlogCategoriaForm extends TWindow
{
    protected $form; // form
    ...
    function __construct()
    {
        ...
        // creates the form
        $this->form = new BootstrapFormBuilder('form_BlogCategoria');
        $this->form->setFormTitle('Formulário de Categoria do Blog');
    ...
    public static function onNomeChange( $param )
    {
        ...
        TForm::sendData('form_BlogCategoria',$obj);
    }
    ...
    public function onSave( $param )
    {
        try
        {
            ...
            new TMessage('info', TAdiantiCoreTranslator::translate('Record saved'), new TAction(['BlogCategoriaList','onClear']));
        }
