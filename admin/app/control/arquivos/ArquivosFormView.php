 ...
 */
class ArquivosFormView extends TPage
{
    protected $form;
    ...
    public function __construct( $param )
    {
        ...
        $this->form = new BootstrapFormBuilder('form_Arquivos_View');
    ...
    public function onView( $param )
    {
        try
        {
            ...
            //var_dump(date ("d/m/Y H:i:s.", filemtime($param['path'].'/'.$param['name'])));
            //var_dump(getimagesize($param['path'].'/'.$param['name']));
            //var_dump(stat($param['path'].'/'.$param['name']));
