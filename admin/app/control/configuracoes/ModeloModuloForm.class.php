<?php
/**
 * ModeloModuloForm Registration
 * @author  <your name here>
 */
class ModeloModuloForm extends TWindow
{
    protected $form; // form
    protected $fieldlist;
    ...
    function __construct()
    {
        ...
        // creates the form
        $this->form = new BootstrapFormBuilder('form_ModeloModulo');
        $this->form->setFormTitle('Formulário de Modelo de Módulo');
    ...
    public function onSave( $param )
    {
        try
        {
            ...
            $object = new ModeloModulo;  // create an empty object
            ...
            new TMessage('info', TAdiantiCoreTranslator::translate('Record saved'), new TAction(['ModeloModuloList','onClear']));
        }
    ...
    public function onEdit( $param )
    {
        try
        {
            if (isset($param['key']))
            {
                ...
                TTransaction::open('sistema'); // open a transaction
                $object = new ModeloModulo($key); // instantiates the Active Record
